...
The assets panel is where all of your Images, Lottie files, and Custom fonts will be added and appear. 
![Alt text for the Asset snapshot](/path/to/Asset/image.jpg)


Read more about importing assets [Importing Assets](../fundamentals/importing-assets).
